from src.ops.game_predictor.bb_blended_true_odds_beta1 import TrueOdds
...
class BbOperatorTrueOdds (BbOperator):
    ...
    def __init__(self, logger: OtLogger):
        self.gamePredictor = TrueOddsHighest(logger)
        BbOperator.__init__(self, logger)


if __name__ == '__main__':
    normal_interval_in_mins = 2
    logger = OtLogger('./logs/ops_bb_true_odds_beta1.log')
