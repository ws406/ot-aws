...
def find_open_final(data, kickoff):
    timeList = []
...
class QualificationCheck:
    ...
    def is_qualified(self, game_data):
        ...
        try:
            ...
            timeList = find_open_final(game_data['odds']['easybet'], game_data['kickoff'])
            ...
            timeList = find_open_final(game_data['probabilities']['easybet'], game_data['kickoff'])
            ...
            timeList = find_open_final(game_data['odds']['skybet'], game_data['kickoff'])
            ...
            timeList = find_open_final(game_data['probabilities']['skybet'], game_data['kickoff'])
            ...
            timeList = find_open_final(game_data['odds']['ladbroke'], game_data['kickoff'])
            ...
            timeList = find_open_final(game_data['probabilities']['ladbroke'], game_data['kickoff'])
            ...
            timeList = find_open_final(game_data['odds']['will_hill'], game_data['kickoff'])
            ...
            timeList = find_open_final(game_data['probabilities']['will_hill'], game_data['kickoff'])
            ...
            foundMarathonbet = False
            try:
                test = game_data['probabilities']['marathonbet']
                test = game_data['odds']['marathonbet']
                timeList = find_open_final(game_data['probabilities']['marathonbet'], game_data['kickoff'])
                ...
                timeList = find_open_final(game_data['odds']['marathonbet'], game_data['kickoff'])
                ...
                foundMarathonbet = True
            except (TypeError, KeyError):
                None

            foundMarathon = False
            try:
                test = game_data['probabilities']['marathon']
                test = game_data['odds']['marathon']
                timeList = find_open_final(game_data['probabilities']['marathon'], game_data['kickoff'])
                game_data['probabilities']['marathon']['open'] = game_data['probabilities']['marathon'][timeList[0]]
                game_data['probabilities']['marathon']['final'] = game_data['probabilities']['marathon'][timeList[1]]
                game_data['probabilities']['marathon']['open']['1'] = float(game_data['probabilities']['marathon']['open']['1'])
                game_data['probabilities']['marathon']['open']['2'] = float(game_data['probabilities']['marathon']['open']['2'])
                game_data['probabilities']['marathon']['final']['1'] = float(game_data['probabilities']['marathon']['final']['1'])
                game_data['probabilities']['marathon']['final']['2'] = float(game_data['probabilities']['marathon']['final']['2'])
                timeList = find_open_final(game_data['odds']['marathon'], game_data['kickoff'])
                game_data['odds']['marathon']['open'] = game_data['odds']['marathon'][timeList[0]]
                game_data['odds']['marathon']['final'] = game_data['odds']['marathon'][timeList[1]]
                game_data['odds']['marathon']['open']['1'] = float(game_data['odds']['marathon']['open']['1'])
                game_data['odds']['marathon']['open']['2'] = float(game_data['odds']['marathon']['open']['2'])
                game_data['odds']['marathon']['final']['1'] = float(game_data['odds']['marathon']['final']['1'])
                game_data['odds']['marathon']['final']['2'] = float(game_data['odds']['marathon']['final']['2'])
                foundMarathon = True
            except (TypeError, KeyError):
                None

            if foundMarathonbet:
                if foundMarathon and len(game_data['odds']['marathon']) > len(game_data['odds']['marathonbet']):
                    game_data['odds']['marathonbet'] = game_data['odds']['marathon']
                    game_data['probabilities']['marathonbet'] = game_data['probabilities']['marathon']
            else:
                if foundMarathon:
                    game_data['odds']['marathonbet'] = game_data['odds']['marathon']
                    game_data['probabilities']['marathonbet'] = game_data['probabilities']['marathon']

            timeList = find_open_final(game_data['odds']['pinnacle'], game_data['kickoff'])
            ...
            timeList = find_open_final(game_data['probabilities']['pinnacle'], game_data['kickoff'])
            ...
            if (game_data['probabilities']['marathonbet']['open']['2'] < game_data['probabilities']['marathonbet']['final']['2'] and \
               ...
               (game_data['probabilities']['ladbroke']['open']['2'] < game_data['probabilities']['ladbroke']['final']['2'] and \
                game_data['probabilities']['ladbroke']['open']['1'] > game_data['probabilities']['ladbroke']['final']['1']) or\
