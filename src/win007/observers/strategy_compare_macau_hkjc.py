...
from src.win007.observers.compare_macau_hkjc.qualification_check import QualificationCheck


class MacauHKObserver(ObserverInterface):

    qualification_checker = None

    def __init__(self):
        super(MacauHKObserver, self).__init__()
